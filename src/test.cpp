/*$T indentinput.cpp GC 1.140 09/19/20 19:42:20 */
                ...
                S3()
{
 ...
 label:
        ...
        /*
         * Switch blocks: You can have case substatements be aligned by giving an example
         * like: case 1: statement;
         * statement;
         * statement;
         * etc..
         */
...
static void A<x>::      method()[][][]
{
        asm
        {
                -Assembler statements - The outside braces are formatted but the asm code is passed through unchanged.
        }
...
{
/*
 * Array creation with multiple non-array elements. If you give this example with
 * the elements on the same line, then Polystyle will automatically vertically
 * align them into a grid when it fits your code to the page. An alternate style
 * is to have each element on its own line, like this: { x, y z }
 */
boolean *bools1 = {x, y, z};
...
const int       ***array = {{1, 2, 3}, {1, 2, 3}, {1, 2, 3}, };
};
